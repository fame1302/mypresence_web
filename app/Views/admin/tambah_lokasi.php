...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" action="<?= base_url(); ?>/admin/tambah_lokasi">
                <?= csrf_field() ?>

                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Nama Lokasi</label>
                    <div class="col-sm-5">
                        <input value="<?= old('nama_lokasi'); ?>" name="nama_lokasi" type="text" class="form-control <?= ($validation->hasError('nama_lokasi')) ? 'is-invalid' : ''; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?= old('lat'); ?>" id="latitude" type="text" class="form-control <?= ($validation->hasError('lat')) ? 'is-invalid' : ''; ?>" name="lat" readonly>
                        <div class="invalid-feedback">
                            <?= $validation->showError('lat'); ?>
                        </div>
                        <label for="" class="col-form-label d-block">Longitude :</label>
                        <input value="<?= old('long'); ?>" id="longitude" type="text" class="form-control <?= ($validation->hasError('long')) ? 'is-invalid' : ''; ?>" name="long" readonly>
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    <div class="col-sm-5">
                        <input type="submit" class="btn btn-primary" value="Tambah Lokasi">
                    </div>
                </div>
            </form>
        </div>
