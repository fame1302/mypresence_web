...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" action="<?= base_url(); ?>/admin/edit_karyawan" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input value="<?= (old('nama')) ? old('nama') : $karyawan['nama'] ?>" name="nama" type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="col-sm-5 mt-2">
                        <div class="radio">
                            <label class="col-sm-5">
                                <?php
                                $jk = (old('jk')) ? old('jk') : $karyawan['jenis_kelamin'];
                                ?>
                                <input type="radio" name="jk" value="l" <?= ($jk == 'l') ? 'checked' : ''; ?>>
                                Laki - laki
                            </label>
                            <label class="col-sm-5">
                                <input type="radio" name="jk" value="p" <?= ($jk == 'p') ? 'checked' : ''; ?>>
                                Perempuan
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <textarea name="alamat" cols="30" rows="3" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>"><?= (old('alamat')) ? old('alamat') : $karyawan['alamat'] ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-3">
                        <select name="jabatan" class="form-control ">
                            <?php foreach ($list_jabatan as $jabatan) : ?>
                                <?php $jab = (old('jabatan')) ? old('jabatan') : $karyawan['id_jabatan']; ?>
                                <option value="<?= $jabatan['id']; ?>" <?= ($jab == $jabatan['id']) ? 'selected' : ''; ?>><?= $jabatan['nama_jabatan']; ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input value="<?= $karyawan['username'] ?>" name="username" type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input value="<?= $karyawan['email'] ?>" name="email" type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input value="<?= $karyawan['password'] ?>" name="password" type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?> ">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select name="level" class="form-control ">
                            <option value="0" <?= ($karyawan['level'] == 0) ? 'selected' : ''; ?>>User</option>
                            <option value="1" <?= ($karyawan['level'] == 1) ? 'selected' : ''; ?>>Admin</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
