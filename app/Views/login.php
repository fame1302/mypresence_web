              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="/login">
                    ...
                    <div class="form-group">
                      <input name="password" type="password" class="form-control <?= ($validation->hasError('password') || isset(session()->error)) ? 'is-invalid' : ''; ?>" id="exampleInputPassword" placeholder="Password">
                      <div class="invalid-feedback">
